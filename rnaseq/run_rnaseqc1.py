...
# this is an OUTDATED copy of run_rnaseqc.py that runs RNA-SeQC 1.1.9
# source:
# https://github.com/broadinstitute/gtex-pipeline/blob/0ef05fed00fd37d9ec79894cf596436a0796fe36/rnaseq/src/run_rnaseqc.py
# it ships with no promise of working
import argparse
import pandas as pd
import subprocess
